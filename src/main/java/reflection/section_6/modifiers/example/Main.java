package reflection.section_6.modifiers.example;

import reflection.section_6.modifiers.example.auction.*;
...
//        printClassModifiers(Class.forName("reflection.section_6.modifiers.example.auction.Bid$Builder$BidImpl"));
