package reflection.section_3.json_converter_array.jsonwriter;
...
import reflection.section_3.json_converter_array.data.Actor;
import reflection.section_3.json_converter_array.data.Movie;
...
public class Main {
    public static void main(String[] args) throws IllegalAccessException {
        ...
        Actor actor3 = new Actor("Orlando Bloom", new String[]{"Pirates of Caribbean","Kingdon of Heaven" });
    ...
    private static String arrayToJson(Object arrayInstance, int indentSize) throws IllegalAccessException {
        ...
        Class<?> componentType = arrayInstance.getClass().componentType();
        ...
        for(int i=0; i<arrayLength;i++){
            ...
            if(componentType.isPrimitive()){
                ...
                stringBuilder.append(indent(indentSize + 1));
                stringBuilder.append(arrayToJson(element, indentSize));
            } else {
