package reflection.section_5.methods.invokingMethods;

import reflection.section_5.methods.invokingMethods.database.DatabaseClient;
import reflection.section_5.methods.invokingMethods.http.HttpClient;
import reflection.section_5.methods.invokingMethods.logger.FileLogger;
import reflection.section_5.methods.invokingMethods.udp.UdpClient;
       ...
       try {
           for (Map.Entry<Object, Method> requestExecutorEntry : requestExecutors.entrySet()) {
               ...
               if (result != null && result.equals(Boolean.FALSE)) {
                   System.out.println("Received negative result. Abprting ...");
                   return;
               }
           }
